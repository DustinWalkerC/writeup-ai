        ...
        >
          ...
          >
            ...
            <button
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.background = P.bgAlt;
                e.currentTarget.style.borderColor = P.border;
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.background = P.bgWarm;
                e.currentTarget.style.borderColor = P.borderL;
              }}
            >
...
export default function ReportStylePanel({
  ...
  const isLocked = (requiredTier: TierLevel): boolean => TIER_RANK[tier] < TIER_RANK[requiredTier];
  ...
  return (
    <div style={{ fontFamily: 'var(--font-body, "DM Sans", system-ui, sans-serif)' }}>
      ...
      <div style={{ marginBottom: 20 }}>
        ...
        <p style={{ fontSize: 13, color: P.textSoft, margin: 0 }}>Configure how the AI writes and analyzes your reports</p>
      </div>
      ...
      >
        ...
        {/* ── Negative Format ── */}
        <ControlSection label="Negative Number Format" sublabel="How negative values appear in your report">
          <OptionGrid
            options={[
          ...
          {!hideSaveButton && (
            <button
              ...
              style={{
                ...
                fontWeight: 600,
                color: '#fff',
                background: isSaving ? P.textMuted : P.accent,
                border: 'none',
                borderRadius: 10,
      ...
      {/* ── Info Popup Portal ── */}
      {activePopup && <InfoPopup contentKey={activePopup} isOpen={true} onClose={() => setActivePopup(null)} />}
...
function ControlSection({
  ...
  return (
    ...
    >
      ...
      <div style={{ pointerEvents: locked ? 'none' : 'auto' }}>{children}</div>
    </div>
  );
}
      ...
      {options.map((opt) => {
        ...
        return (
          <button
            ...
            onMouseEnter={(e) => {
              if (!disabled && !isSelected) e.currentTarget.style.borderColor = P.border;
            }}
            onMouseLeave={(e) => {
              if (!disabled && !isSelected) e.currentTarget.style.borderColor = P.borderL;
            }}
          >
            <div
              style={{
            ...
            <div style={{ fontSize: 11, color: P.textSoft, lineHeight: 1.4 }}>{opt.desc}</div>
          </button>
        );
      })}
    </div>
...
function ToggleSwitch({
  ...
  return (
    <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
      ...
      <span style={{ fontSize: 13, color: checked ? P.text : P.textSoft, fontWeight: 500 }}>{label}</span>
    </div>
  );
}
